var color = require('colors'),                  // Colorize Terminal Output
    ...
    path = require('path');                     // Working with Paths
...
exports.help = function() {
    ...
    console.log('-------------------------------------------'.red);
    console.log('blastoff init'.green + ' - Deploys the Default Asset Structure');
...
exports.init = function(quick) {
    ...
    // Verify Assets Folder Does Not Already Exist
    path.exists(paths.dest, function(exists){
        if (exists) {
            ...
            console.log('Houston we have a problem: '.red);
            console.log('Error: '.yellow + 'Assets folder already exists in this directory');
        }
    });
...
exports.start = function() {
    ...
    process.env.GULP_PATH = dir.indexOf('assets') != -1 ? dir + "/" : dir + "/assets/";
